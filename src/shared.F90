...
module pisces_shared
   ...
   real(rk), parameter :: rDt_trc = 3600._rk  ! physical time-step [s] 
   ...
   type (type_surface_standard_variable), parameter :: dustdep = type_surface_standard_variable(name='dustdep', units='Kg m-2 s-1')
 ...
 !  type (type_horizontal_standard_variable), parameter :: cell_area = type_horizontal_standard_variable(name='cell_area', units='m2') ! Celle area
   ...
   type (type_universal_standard_variable), parameter :: consfe3_sum = type_universal_standard_variable(name='consfe3_sum', units='-', aggregate_variable=.true.)
